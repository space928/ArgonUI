...
/// <summary>
/// A style selector which selects elements the mouse is currently hovering over.
/// </summary>
/// <param name="invert">Whether the behaviour of this selector should be inverted.</param>
public class HoveredSelector(bool invert = false) : IStyleSelector, IFlattenedStyleSelector
{
    private readonly bool invert = invert;

    /// <summary>
    /// When inverted, the hovered selector selects all elements which the mouse is NOT hovering over.
    /// </summary>
    ...
    private bool SelectElement(UIElement elementTree) => elementTree.IsHovered ^ invert;
    ...
    {
        if (inputChange == UIElementInputChange.MouseHover)
