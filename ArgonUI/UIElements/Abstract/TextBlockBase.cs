...
/// <summary>
/// The base class for any <see cref="UIElement"/> which draws text on top of a <see cref="RectangleBase"/>.
/// </summary>
/// <remarks>
/// With the exception of text wrapping and a background rectangle, this class should have feature parity with <see cref="TextBase"/>.
/// </remarks>
[UIClonable]
